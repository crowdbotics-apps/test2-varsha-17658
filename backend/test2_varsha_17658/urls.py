"""test2_varsha_17658 URL Configuration
...
admin.site.site_header = "test2_varsha"
admin.site.site_title = "test2_varsha Admin Portal"
admin.site.index_title = "test2_varsha Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="test2_varsha API",
        default_version="v1",
        description="API documentation for test2_varsha App",
    ),
    public=True,
